class NewComicSource extends ComicSource {
    ...
    baseDomain = "https://www.mwfa.cc"
    backupDomains = [
        "https://www.mwda.cc",
        "https://www.mwfu.cc",
        "https://www.manwaku.com",
        "https://www.manwaku.cc"
    ]

    async getAvailableDomain() {
        for (const domain of [this.baseDomain, ...this.backupDomains]) {
            try {
                let res = await Network.get(`${domain}/favicon.ico`, {
                ...
                console.log("⚠️ 域名不可用: " + domain);
            }
        }
        console.log("⚠️ 检测失败，使用主域名");
    ...
    imageSources = [
        ...
        'https://fm.mwtt.cc',
        'https://tu.mwzu.cc',
        'https://tu.mihoutao.vip',
        'https://by.mihoutao.vip',
        'https://ssvip.mwtt.cc'
    ]
    ...
    async retryImageRequest(url, options, maxRetries = 4) {
    ...
    settings = {
        ...
        image_source: {
            ...
            type: "select",
            options: [
                { value: 'https://tu.mhttu.cc', text: 'high' },
                { value: 'https://svip.mwtt.cc', text: 'svip' },
                { value: 'https://fm.mwtt.cc', text: 'fm' },
                { value: 'https://tu.mwzu.cc', text: 'mwzu' },
                { value: 'https://tu.mihoutao.vip', text: 'stable' },
                { value: 'https://by.mihoutao.vip', text: 'standby' },
                { value: 'https://ssvip.mwtt.cc', text: 'ssvip会员' }
            ],
